...
<head>
    <title>Code coverage report for ua/NodeId.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ua</a> NodeId.js</h1>
        <div class='clearfix'>
...
<span class="branch-3 cbranch-no" title="branch not covered" >            case exports.NodeIdTypeGuid: {</span>
<span class="cstat-no" title="statement not covered" >                bucket.writeUint16(this.Namespace);</span>
<span class="cstat-no" title="statement not covered" >                bucket.writeStruct(this.Identifier);</span>
...
<span class="cstat-no" title="statement not covered" >                throw new Error(`invalid node id type ${this.Type}`);</span>
        }
        return bucket.bytes;
    }
    decode(b, position) {
        ...
        switch (this.type()) {
            ...
            case exports.NodeIdTypeString:
                ...
                return bucket.position;
<span class="branch-5 cbranch-no" title="branch not covered" >            case exports.NodeIdTypeGuid:</span>
<span class="cstat-no" title="statement not covered" >                this.Namespace = bucket.readUint16();</span>
<span class="cstat-no" title="statement not covered" >                this.Identifier = new Guid_1.default();</span>
<span class="cstat-no" title="statement not covered" >                bucket.readStruct(this.Identifier);</span>
