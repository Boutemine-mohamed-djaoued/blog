...
<head>
    <title>Code coverage report for uacp/ConnectionProtocolMessageHeader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">uacp</a> ConnectionProtocolMessageHeader.js</h1>
        <div class='clearfix'>
...
class ConnectionProtocolMessageHeader {
    constructor(options) {
        var _a, _b, _c, _d, _e, _f;
        this.MessageType = (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.MessageType, (_b !== null &amp;&amp; _b !== void 0 ? _b : ''));
        this.ChunkType = (_d = (_c = options) === null || _c === void 0 ? void 0 : _c.ChunkType, (_d !== null &amp;&amp; _d !== void 0 ? _d : ''));
...
exports.default = ConnectionProtocolMessageHeader;
&nbsp;</pre></td></tr></table></pre>
