...
<head>
    <title>Code coverage report for ua/decode.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ua</a> decode.js</h1>
        <div class='clearfix'>
...
const NewArray = (subtype, length) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (subtype === 'uint8') {
<span class="cstat-no" title="statement not covered" >        return new Uint8Array(length);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (subtype === 'uint16') {
<span class="cstat-no" title="statement not covered" >        return new Uint16Array(length);</span>
    }
    if (subtype === 'uint32') {
        return new Uint32Array(length);
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (subtype === 'float64') {
<span class="cstat-no" title="statement not covered" >        return new Float64Array(length);</span>
    }
    ...
    switch (type) {
        ...
        default:
            for (const name of Object.getOwnPropertyNames(instance)) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (guards_1.isNotNullObject(instance) &amp;&amp; guards_1.keyInObject(instance, name)) {
