...
<head>
    <title>Code coverage report for ua/ExtensionObject.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ua</a> ExtensionObject.js</h1>
        <div class='clearfix'>
...
class ExtensionObject {
    ...
    decode(b, position) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (length === 0 || length === 0xffffffff) {
<span class="cstat-no" title="statement not covered" >            return bucket.position;</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (name === undefined) {
<span class="cstat-no" title="statement not covered" >            throw new Error(`invalid extension object with id ${this.TypeId.NodeId.Identifier}`);</span>
        }
