...
<head>
    <title>Code coverage report for ua/encode.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ua</a> encode.js</h1>
        <div class='clearfix'>
...
exports.encode = (args) =&gt; {
    ...
    switch (type) {
        ...
        case 'Array': {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (guards_1.isTypedArray(instance) || Array.isArray(instance)) {
