...
<head>
    <title>Code coverage report for uasc/SymmetricSecurityHeader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">uasc</a> SymmetricSecurityHeader.js</h1>
        <div class='clearfix'>
...
class SymmetricSecurityHeader {
    constructor(options) {
        var _a, _b;
        this.TokenId = (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.TokenId, (_b !== null &amp;&amp; _b !== void 0 ? _b : 0));
    }
    encode() {
...
exports.default = SymmetricSecurityHeader;
&nbsp;</pre></td></tr></table></pre>
