...
const AsymmetricSecurityHeader_1 = __importDefault(require("./AsymmetricSecurityHeader"));
const run_1 = __importDefault(require("../ua/run"));
describe('AsymmetricSecurityHeader', () => {
    run_1.default([
        {
            name: 'normal',
            instance: new AsymmetricSecurityHeader_1.default({
