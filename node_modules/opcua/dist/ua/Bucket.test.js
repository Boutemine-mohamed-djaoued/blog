...
const NodeId_1 = __importStar(require("./NodeId"));
describe('Bucket', () => {
    test('readInt8', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x01]).buffer);
    ...
    test('readInt16', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x01, 0x00]).buffer);
    ...
    test('readInt32', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x01, 0x00, 0x00, 0x00]).buffer);
    ...
    test('readFloat32', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0xb6, 0xf3, 0x9d, 0x3f]).buffer);
    ...
    test('readInt64', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0xfb, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]).buffer);
    ...
    test('readUint64', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0xef, 0xcd, 0xab, 0x90, 0x78, 0x56, 0x34, 0x12]).buffer);
    ...
    test('readFloat64', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x58, 0x39, 0xb4, 0xc8, 0x76, 0xbe, 0xf3, 0xbf]).buffer);
    ...
    test('readString', () => {
        // prettier-ignore
        const bucket = new Bucket_1.default(new Uint8Array([
    ...
    test('readStringBytes', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x41, 0x43, 0x4b]).buffer);
    ...
    test('readStruct', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x00, 0x00]).buffer);
        const v = new NodeId_1.default();
        bucket.readStruct(v);
        expect(JSON.stringify(v)).toEqual(JSON.stringify(NodeId_1.NewTwoByteNodeId(0)));
    });
    test('writeStruct', () => {
        const bucket = new Bucket_1.default();
        bucket.writeStruct(NodeId_1.NewTwoByteNodeId(0));
        // prettier-ignore
        const expected = new Uint8Array([
            0x00, 0x00
        ]);
    ...
    test('readDate', () => {
        const bucket = new Bucket_1.default(new Uint8Array([0x00, 0x98, 0x67, 0xdd, 0xfd, 0x30, 0xd4, 0x01]).buffer);
        expect(bucket.readDate()).toEqual(new Date(Date.UTC(2018, 7, 10, 23, 0, 0, 0)));
    });
    test('writeDate', () => {
        const bucket = new Bucket_1.default();
