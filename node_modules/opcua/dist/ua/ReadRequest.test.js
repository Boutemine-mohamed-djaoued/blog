...
describe('ReadRequest', () => {
    run_1.default([
        {
            name: 'normal',
            instance: new generated_1.ReadRequest({
                RequestHeader: new generated_1.RequestHeader({
                    // prettier-ignore
                    AuthenticationToken: NodeId_1.NewByteStringNodeId(0x00, new Uint8Array([
                    ...
                    RequestHandle: 1,
                    AdditionalHeader: new ExtensionObject_1.default()
                }),
                MaxAge: 0,
                TimestampsToReturn: generated_1.TimestampsToReturnBoth,
                NodesToRead: [
                    new generated_1.ReadValueId({
                        NodeId: NodeId_1.NewFourByteNodeId(0, 2256),
                        AttributeId: enums_1.AttributeIdValue,
                        DataEncoding: new QualifiedName_1.default()
                    })
                ]
            }),
            // prettier-ignore
