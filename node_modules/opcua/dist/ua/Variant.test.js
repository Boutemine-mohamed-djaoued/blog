...
describe('Variant', () => {
    run_1.default([
        {
            name: 'boolean',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdBoolean,
                Value: false
            }),
        ...
        },
        {
            name: 'int8',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdSByte,
                Value: -5
            }),
        ...
        },
        {
            name: 'uint8',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdByte,
                Value: 5
            }),
        ...
        },
        {
            name: 'int16',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdInt16,
                Value: -5
            }),
        ...
        },
        {
            name: 'uint16',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdUint16,
                Value: 5
            }),
        ...
        },
        {
            name: 'int32',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdInt32,
                Value: -5
            }),
        ...
        },
        {
            name: 'uint32',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdUint32,
                Value: 5
            }),
        ...
        },
        {
            name: 'int64',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdInt64,
                Value: BigInt(-5)
            }),
            // prettier-ignore
        ...
        },
        {
            name: 'uint64',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdUint64,
                Value: BigInt(5)
            }),
            // prettier-ignore
            bytes: new Uint8Array([
        ...
        },
        {
            name: 'float32',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdFloat,
        ...
        },
        {
            name: 'float64',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdDouble,
                Value: 4.00067
            }),
            // prettier-ignore
            bytes: new Uint8Array([
        ...
        },
        {
            name: 'string',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdString,
                Value: 'abc'
            }),
        ...
        },
        {
            name: 'DateTime',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdDateTime,
        ...
        },
        {
            name: 'Guid',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdGUID,
                Value: new Guid_1.default('72962B91-FA75-4AE6-8D28-B404DC7DAF63')
            }),
            // prettier-ignore
            bytes: new Uint8Array([
        ...
        },
        {
            name: 'ByteString',
            instance: new Variant_1.default({
                EncodingMask: enums_1.TypeIdByteString,
