  ...
  render() {
    return hElement("nav", { class: "navbar" }, [
      ...
      hElement("ul", { class: "navbar-links" }, [
        hElement("li", {}, [hElement(RouterLink, { props: { to: "/" } }, ["Home"])]),
        hElement("li", {}, [hElement(RouterLink, { props: { to: "/notes" } }, ["Web Notes"])]),
        hElement("li", {}, [hElement(RouterLink, { props: { to: "/writeups" } }, ["write-ups"])]),
